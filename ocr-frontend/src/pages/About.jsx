...
export default function About() {
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', lineHeight: '1.6' }}>
      <br />
      <h1 style={{ color: '#06b6d4', fontFamily: 'Noto Sans Tamil', fontSize: '20px' }}>எங்களை பற்றி</h1>
      <p style={{ fontFamily: 'Latha, Arial, sans-serif', fontSize: '16px', padding: '5px 20px 5px 25px' }}>
      ...
      <br />
      <h2 style={{ color: '#1e40af', fontFamily: 'Latha, Arial, sans-serif', fontSize: '20px'  }}>எங்கள் நோக்கம்</h2>
      <p style={{ fontFamily: 'Latha, Arial, sans-serif', fontSize: '16px', padding: '5px 20px 5px 25px' }}>
      ...
      <br />
      <h2 style={{ color: '#1e40af', fontFamily: 'Latha, Arial, sans-serif', fontSize: '20px'  }}>சிறப்பம்சங்கள்</h2>
      <ul style={{ fontFamily: 'Latha, Arial, sans-serif', fontSize: '16px', padding: '5px 20px 5px 25px' }}>
      ...
      <br />
      <h2 style={{ color: '#1e40af', fontFamily: 'Latha, Arial, sans-serif', fontSize: '20px'  }}>ஏன் எங்களை தேர்வு செய்ய வேண்டும்?</h2>
      <p style={{ fontFamily: 'Latha, Arial, sans-serif', fontSize: '16px', padding: '5px 20px 5px 25px' }}>
